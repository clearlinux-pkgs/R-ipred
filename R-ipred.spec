...
Version  : 0.9.10
Release  : 35
URL      : https://cran.r-project.org/src/contrib/ipred_0.9-10.tar.gz
Source0  : https://cran.r-project.org/src/contrib/ipred_0.9-10.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614874728
